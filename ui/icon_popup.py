...
from PySide6.QtCore import Qt, QPoint, QTimer, QObject, Signal, Property, QPropertyAnimation, QEasingCurve, QRect
...
class ButtonCircle(QWidget):
    ...
    def create_buttons(self):
        for i in range(self.num_buttons):
            ...
            self.target_geometries.append(QRect(x, y, self.button_size, self.button_size))
